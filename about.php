...
<div class="mt-2 container">
  <div class="rounded-3 w-25" style="background-color:#f8bbd0;">
    <h2 class="ps-2 fs-3 text-white">Quienes somos</h2>
  </div>
  <div class="mt-2">
    ...
    <div class="row">
      <div class="col-md-12">
        <p class="fs-4">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. In qui quo distinctio nobis quisquam. Consectetur illo ducimus quas quis expedita nulla numquam possimus voluptate accusantium! Ipsam iure accusantium debitis tempora!
        </p>
      </div>
